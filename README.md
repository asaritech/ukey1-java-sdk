...
This repository contains the open source Java SDK that allows you to access the **[Ukey1 API](http://ukey.one)** from your Java app.
...
If you want to become a contributor of this Java SDK, please first contact us (see our email below). 
